...
namespace Practico2
{
    public partial class Form1 : Form
    {
        ...
        private void RBVaron_CheckedChanged(object sender, EventArgs e)
        {
            if (RBVaron.Checked)
            {
                PImagen.Image = System.Drawing.Image.FromFile(@"C:\Users\Jonii\Desktop\taller 2\hombre.jpg");
            }
        }
        ...
        private void RBMujer_CheckedChanged(object sender, EventArgs e)
        {
            if (RBMujer.Checked)
            {
                PImagen.Image = System.Drawing.Image.FromFile(@"C:\Users\Jonii\Desktop\taller 2\mujer.jpg");
            }
        }
    }
}
